...
<c:set var="errorMsg" value="${requestScope.error}"/>
	<c:if test="${errorMsg eq 'blank'}">
		<script>alert("글을 작성해주세요!");</script>
	</c:if>
	...
	<div class="row">
		<form action="con" method="post">
			...
			<table class="table table-striped" style="text-align:center;border:1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" id="bbsTitle" name="bbsTitle" maxlength="50"/></td>
					</tr>
				</tbody>
			</table>
